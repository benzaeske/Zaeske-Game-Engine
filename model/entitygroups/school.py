...
from model.entities.entity import FrameActionContext, Entity
...
class School(EntityGroup):
    def __init__(self, amount: int, hatch_region: Rect, fish_config: FishConfig, sprite: Surface) -> None:
        super().__init__()
    ...
    def hatch(self, context: FrameActionContext) -> None:
        ...
        for _ in range(self._amount):
            ...
            context.grid_space_access.add_entity(new_fish, None)
